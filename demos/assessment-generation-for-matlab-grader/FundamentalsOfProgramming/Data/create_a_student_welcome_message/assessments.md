...
| --- | --- | --- | --- | --- | --- |
| Combine text, `studentName`, and numeric `studentId` into the required message | Variable equals reference solution | Variable name: `welcomeMessage` | Not applicable | Matches the reference string scalar for the randomized primary identifier | LO: create a string scalar from text and numeric data |
